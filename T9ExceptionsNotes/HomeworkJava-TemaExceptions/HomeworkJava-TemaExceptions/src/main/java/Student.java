...
public class Student {
    private static final Logger loggerStud = Logger.getLogger(Student.class.getName());
    ...
    public static boolean verifyEmpty(String name) throws Validation { // this was @NotNull before String name
